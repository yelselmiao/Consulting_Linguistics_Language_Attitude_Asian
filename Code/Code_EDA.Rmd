...
und_df_race <- recording_df %>%
  ...
  # short to long 
und_long_race <- und_df_race %>%  
  select(white_easy_und, asian_easy_und, id) %>% 
  rename(White = white_easy_und,
         Asian = asian_easy_und) %>% 
  gather(key = "Race", value = "value", White, Asian) %>%
  convert_as_factor(id, Race)
